...
<head>
  ...
  <title>Dashboard | Kelurahan Mawang </title>
  ...
  <!-- Ionicons -->
<link rel="stylesheet" href="{{ URL::asset('assets/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css') }}">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img src="{{ URL::asset('assets/dist/img/gowa.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<!-- jQuery -->
'_<script src="{{URL::asset('assets/plugins/jquery/jquery.min.js')}}"></script>
<!-- jQuery UI 1.11.4 -->
